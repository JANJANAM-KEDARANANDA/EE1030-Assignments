...
\end{enumerate}
\end{multicols}
\item[21.] The angle between the tangents drawn from the point $\vec{(1,4)}$ to the parabola $y^{2}=4x$ is 
...
\end{enumerate}
\end{multicols}
\item[24.] Tangent to the curve $y=x^{2}+6$ at a point $\vec{(1,7)}$ touches the circle $x^{2}+y^{2}+16x+12y+c=0$ at a point Q.Then the coordinates of Q are \hfill{(2005S)}
\begin{multicols}{2}
\begin{enumerate}
    \item$\vec{(-6,-11)}$\\\\
    \item$\vec{(-9,-13)}$
